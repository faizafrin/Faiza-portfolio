  ...
  return (
    <nav>
      <div className="nav_left">
        <h3>
          <span className="hi">Faiza</span>Afrin
        </h3>
      </div>
      <div className="nav_right" id={open ? null : "hide"}>
        ...
        <h6>
          <Link
            ...
            onClick={closeMenu}
          >
            < EmojiObjectsIcon className="nav-icon" /> Internship
          </Link>
          </h6>
        <h6>
          <Link
        ...
        <h6>
          <a
            className="resume"
            to="contact"
            href="https://drive.google.com/file/d/1JA_AW0af82fbK8huLc7nWJplYtjOrmf-/view?usp=drive_link"
            target="_blank"
            rel="noreferrer"
            onClick={closeMenu}
          >
