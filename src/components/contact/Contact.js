            ...
            <div className="col-sm-12 col-md-6 contact-left-container">
              ...
              <div>
                <div className="contact-icon">
                  {/* <p className='contact-icon' onClick={() =>window.open("https://wa.me/+918148441040", "_blank")}> <WhatsAppIcon fontSize='medium' /> +91 9566940955</p> */}
                  <p 
                    onClick={() =>
                      window.open("https://github.com/faizafrin", "_blank")
                    }
                  >
                  ...
                  <p
                    onClick={() =>
                      window.open(
                        "https://www.linkedin.com/in/faizaafrin05/",
                        "_blank"
                      )
                    }
                  >
                  ...
                  <p
                    onClick={() => window.open("tel://+918148441040", "_blank")}
                  >
                    <CallIcon fontSize="medium" /> +91 8148441040
                  </p>
                  <p className="ss"
                    onClick={() =>
                      window.open("mailto:faizasworld2022@gmail.com", "_blank")
                    }
                  >
                    <MailIcon fontSize="medium" /> faizasworld2022@gmail.com
                  </p>
                </div>
                <div>
                  <img
